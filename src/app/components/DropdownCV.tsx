      ...
      >
        <MenuItems className="absolute z-10 mt-2 w-[8rem] origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          <div className="py-1">
            ...
            <MenuItem>
              {({ focus }: any) => (
                <Link href="https://drive.google.com/file/d/1G-TEldv7jOjhQ3xh_H6CrOcOpfm9RFgb/view?usp=sharing"><h4 className=' sm:pt-[0.5rem] flex flex-row ' ><Image src={brFlagIcon} className='ml-[50px]' alt='brf' />Currículo</h4></Link>
              )}
            </MenuItem>
          </div>
        </MenuItems>
