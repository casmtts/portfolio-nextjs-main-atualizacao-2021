  ...
  return (
    <div className='flex ml-[4rem] sm:pb-[18rem] lg:pb-[27rem] w-90% min-w-320 '>
      ...
      <div>
        ...
        <div className=" sm:text-center sm:mt-[2rem] lg:text-2xl lg:ml-[-22rem] lg:mt-[-6rem] 2xl:mt-[-9rem] 2xl:ml-[-30rem] xl:text-4xl 2xl:text-4xl 2xl:text-5xl 3xl:ml-[-35rem] 3xl:mt-[-11rem] text-[#53DA00E6] font-bold "> <p className='animate__bounceIn'>CALIL SOUSA MATTOS</p> </div>
        <div className='animate__animated animate__pulse'>
          <div className=" sm:text-center lg:ml-[-21.8rem] xl:text-xl 2xl:text-xl 2xl:ml-[-31rem] 3xl:ml-[-36rem] 3xl:text-2xl font-semibold "> {t('position')} </div>
        </div>
