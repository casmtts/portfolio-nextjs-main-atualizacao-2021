...
function Profile() {
  ...
  return (
    <section className='profile-shell ml-sidebar flex min-h-[calc(100svh-4rem)] w-[calc(100%-4rem)] min-w-0 items-center justify-center px-5 py-[3.4rem] xs:px-6 sm:px-8 md:px-10 lg:px-12 xl:px-16'>
